...
Public Class dineroCaja
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        ' Ingresa el valor a la tabla SM_CORTE_CAJA
        ...
        objCommand.CommandText = "INSERTAR_DINERO_INICIAL"
        ...
        Catch ex As Exception
            MessageBox.Show("Error al tratar de realizar la inserción de los datos.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
