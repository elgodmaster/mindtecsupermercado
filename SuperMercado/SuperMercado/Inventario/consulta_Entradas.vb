Public Class consulta_Entradas
...
#Region " Label "
    ...
    Class LabelExt
        Inherits Label
        Private padre As consulta_Entradas
        Private filt As String
        Public Sub New(ByVal padre As consulta_Entradas)
            MyBase.New()
            Me.padre = padre
            filt = ""
        End Sub
    ...
    Class KeyEvent
        ...
        Dim padre As consulta_Entradas
        Public Sub New(ByVal frm As consulta_Entradas)
            MyBase.New()
            padre = frm
        End Sub
