...
#Region "Eventos"
    Private Sub consulta_Entradas_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
...
#Region " Label "
    ...
    Class LabelExt
        Inherits Label
        Private padre As Entradas
        Private filt As String
        Public Sub New(ByVal padre As Entradas)
            MyBase.New()
            Me.padre = padre
            filt = ""
        End Sub
    ...
    Class KeyEvent
        ...
        Dim padre As Entradas
        Public Sub New(ByVal frm As Entradas)
            MyBase.New()
            padre = frm
        End Sub
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        MessageBox.Show("cell2,13" + suma.ToString)
    End Sub
    ...
    Sub Excelazo()
        ...
        Try
            ...
            exLibro = exApp.Workbooks.Open("F:\MindTec\PRUEBAS_PROYECTOS\PruebasReportes\PruebasReportes\Componentes\Reportes\PlantillaReportesEntrada.xlsx")
