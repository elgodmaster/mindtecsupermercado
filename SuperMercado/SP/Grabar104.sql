...
drop proc dbo.GRABAR104
go

CREATE PROCEDURE dbo.GRABAR104
(
...
--set quoted_identifier off
  ...
  If Len(RTrim(LTrim(@Valor1)))= 0
   Begin
     Select @Resul='2R=ERROR|2M=Registre el código de la unidad para continuar|'
     Return    
   End
